...
public class mailling {
   ...
   property.put("mail.transport.protocl","smtp");
     ...
     Session session = Session.getInstance(property, new Authenticator() {
        ...
        return new PasswordAuthentication("easyfit271@gmail.com","Easy*1fit123");
        }
     ...
     // craeation of an empty object hen you fill the content with whatever you want 
        Message message = new MimeMessage(session);
          ...
          Address addressTo = new InternetAddress("boutheina.lagrem@esprit.tn");
...
"      <img align=\"center\" border=\"0\" src=\"Image/logo.png\" alt=\"Logo\" title=\"Logo\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 108px;\" width=\"108\" class=\"v-src-width v-src-max-width\"/>\n" +
"      </a>\n" +
"    </td>\n" +
"  </tr>\n" +
"</table>\n" +
...
"<p style=\"font-size: 14px; line-height: 180%;\"><br /><span style=\"font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;\">Vous faites partie de notre team. Welcome!</span></p>\n" +
                  
"<p style=\"font-size: 14px; line-height: 180%;\"><br /><strong><span style=\"font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;\">Best regards,</span></strong><br /><span style=\"font-size: 16px; line-height: 28.8px; font-family: 'trebuchet ms', geneva;\">[EasyFit]</span></p>\n" +
"  </div>\n" +
"\n" +
"      </td>\n" +
"    </tr>\n" +
...
"</html>";
          messageBodyPart.setContent(htmlText,"text/html");
           ...
           MimeBodyPart fileAttach = new MimeBodyPart();
            fileAttach.attachFile(new File("C:\\Users\\LENOVO\\Downloads\\bobo.jpg"));
